...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gwtwithhibernate" because\n';
  ...
  $wnd.__gwt_activeModules['gwtwithhibernate'] = {
    'moduleName' : 'gwtwithhibernate',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/gwtwithhibernate.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gwtwithhibernate'].superdevmode = true;

  var expectedSuffix = '/gwtwithhibernate.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gwtwithhibernate + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gwtwithhibernate';
  var devModeSessionKey = '__gwtDevModeSession:gwtwithhibernate';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/gwtwithhibernate/gwtwithhibernate.nocache.js';
  ...
  $wnd.__gwt_activeModules['gwtwithhibernate'].canRedirect = true;
  $wnd.__gwt_activeModules['gwtwithhibernate'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING gwtwithhibernate';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gwtwithhibernate?user.agent=' + ua + '&_callback=' + callback;
